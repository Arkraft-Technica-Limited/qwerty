# Qwerty Chat Privacy Policy

*Last updated: January 2025*

## Our Commitment

Qwerty Chat is designed with privacy as its foundation. We believe private communication is a fundamental human right. This policy explains how Qwerty Chat protects your privacy.
...
- **Hybrid Functionality** - Qwerty Chat offers two modes of communication:
...
## What Information Qwerty Chat Stores
...
During each session, Qwerty Chat temporarily maintains:
...
### With Other Qwerty Chat Users

When you use Qwerty Chat, nearby peers can see:
...
To provide the core functionality of Qwerty Chat, we access your device's location data. This access is necessary for the following specific purposes:
...
- **How we use it:** We use this permission strictly to discover other Qwerty Chat peers nearby for the "Bluetooth Mesh Chat" mode.
...
Qwerty Chat does not knowingly collect information from children. The app has no age verification because it collects no personal information from anyone.
...
Qwerty Chat is an open source project. For privacy questions:
- Review our code: https://github.com/Arkraft-Technica-Limited/qwerty
- Open an issue on GitHub
- Join the discussion in public rooms

## Philosophy

Privacy isn't just a feature—it's the entire point. Qwerty Chat proves that modern communication doesn't require surrendering your privacy. No accounts, no servers, no surveillance. Just people talking freely.

---

*This policy is released into the public domain under The Unlicense, just like Qwerty Chat itself.*