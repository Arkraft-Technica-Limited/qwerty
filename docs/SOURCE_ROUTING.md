# Source-Based Routing for Qwerty Chat Packets (v2)

This document specifies the Source-Based Routing extension (v2) for the Qwerty Chat protocol. This upgrade enables efficient unicast routing across the mesh by allowing senders to specify an explicit path of intermediate relays.
