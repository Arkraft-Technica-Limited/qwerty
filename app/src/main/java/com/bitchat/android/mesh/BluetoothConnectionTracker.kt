...
class BluetoothConnectionTracker(
    ...
    companion object {
        ...
        private const val CONNECTION_RETRY_DELAY = tech.arkraft.qwerty.util.AppConstants.Mesh.CONNECTION_RETRY_DELAY_MS
        private const val MAX_CONNECTION_ATTEMPTS = tech.arkraft.qwerty.util.AppConstants.Mesh.MAX_CONNECTION_ATTEMPTS
        private const val CLEANUP_DELAY = tech.arkraft.qwerty.util.AppConstants.Mesh.CONNECTION_CLEANUP_DELAY_MS
        private const val CLEANUP_INTERVAL = tech.arkraft.qwerty.util.AppConstants.Mesh.CONNECTION_CLEANUP_INTERVAL_MS // 30 seconds
    }
