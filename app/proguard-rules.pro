...
-keep class tech.arkraft.qwerty.protocol.** { *; }
-keep class tech.arkraft.qwerty.crypto.** { *; }
-dontwarn org.bouncycastle.**
-keep class org.bouncycastle.** { *; }

# Keep SecureIdentityStateManager from being obfuscated to prevent reflection issues
-keep class tech.arkraft.qwerty.identity.SecureIdentityStateManager {
    private android.content.SharedPreferences prefs;
    *;
}

# Keep all classes that might use reflection
-keep class tech.arkraft.qwerty.favorites.** { *; }
-keep class tech.arkraft.qwerty.nostr.** { *; }
-keep class tech.arkraft.qwerty.identity.** { *; }

# Keep Tor implementation (always included)
-keep class tech.arkraft.qwerty.net.RealTorProvider { *; }
